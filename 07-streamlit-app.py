...
# streamlit run 07-streamlit-app.py
# 최종
...
def load_faiss():
    ...
    vector_store = FAISS.load_local('./db/faiss241019-ada', OpenAIEmbeddings(), allow_dangerous_deserialization=True)
...
def process_user_input(query, vector_store):
    ...
    When you answer the recipe you have to describe with title,
    ingredients with bullet list, cooking order with numbered list 
    and skill level. You should speak in Korean language.
